...
public class Food {
	...
	public Food(int code, String name, double supportpereat, double calory, double carbo, double protein, double fat,
			...
			String material, String img, String[] u_Allergy) {
		super();
		this.code = code;
		this.name = name;
	...
	public String toString() {
		return "Food [code=" + code + ", name=" + name + ", supportpereat=" + supportpereat + ", calory=" + calory
				...
				+ maker + ", 원료=" + material + ", img=" + img + ", allergy=" + Arrays.toString(u_Allergy) + "]";
	}
	...
	public String[] getU_Allergy() {
		return u_Allergy;
	}



	public void setU_Allergy(String[] u_Allergy) {
		this.u_Allergy = u_Allergy;
	}


	public String [] allergyStringConvertArr(String arr) {
		return arr.split(" ");
	}

	
	public String allergyArrConvertString() {
		String allergyStr = "";
		for (String a : this.u_Allergy) {
			allergyStr += a + " ";
		}
		return allergyStr;
