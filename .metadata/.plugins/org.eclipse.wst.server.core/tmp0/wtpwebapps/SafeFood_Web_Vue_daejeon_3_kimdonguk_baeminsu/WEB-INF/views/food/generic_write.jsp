...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<form action="food_add_af.do" name="food"
				...
				<div class="inner">
					<section>
						<div class="row gtr-uniform">
							<div class="col-4">
								<span class="image fit"> <img id="prev" src="${info.img}"
									alt="">
								</span> <input type="file" name="uploadFile" size="40"
									onchange="readURL(this);" style="margin:30px">
							</div>
									...
									<table class="productTable">
										<tbody>
											<tr>
												...
												<td><input type="number" name="code" class="input"></td>
											</tr>
											<tr>
					...
					<input type="hidden" value="" id="imgh" name="img"/>
					
					
					<section style="margin-top: 50px; margin-bottom: 50px; margin-left: 30px;">
						<caption>
							<h3>알레르기 성분</h3>
						</caption>
						<div class="row gtr-uniform">
								...
								<div class="table-wrapper">
									<table>
										...
										<thead>
											<tr>
												<th>열량</th>
												<th><input type="number" name="calory" class="input">kcal</th>
											</tr>
										</thead>
										<tbody>
											<tr>
											...
											<tr>
												<td>탄수화물</td>
												<td><input type="number" name="carbo" class="input">g</td>

											</tr>
											<tr>
												<td>나트륨</td>
												<td><input type="number" name="natrium" class="input">mg</td>

											</tr>
											<tr>
												<td>단백질</td>
												<td><input type="number" name="protein" class="input">g</td>

											</tr>
											<tr>
												<td>당류</td>
												<td><input type="number" name="sugar" class="input">g</td>

											</tr>
											<tr>
												<td>지방</td>
												<td><input type="number" name="fat" class="input">g</td>

											</tr>
											<tr>
												<td>포화지방</td>
												<td><input type="number" name="fattyacid" class="input">g</td>

											</tr>
											<tr>
												<td>콜레스테롤</td>
												<td><input type="number" name="chole" class="input">g</td>

											</tr>
											<tr>
												<td>트랜스지방</td>
												<td><input type="number" name="transfat" class="input">g</td>
	...
	<script src="assets/js/main.js"></script>
		...
		$(function() {
			var arr = new Array();
			<c:forEach items="${info.allergy}" var="arr">
				arr.push("${arr}");
			</c:forEach>
			var i;
